...
void MainWindow::printHardwareProblem() {
    widget.output->setText("Cannot compute! Hardware problem occurred.");
}

void MainWindow::printWrongInput() {
    widget.output->setText("Cannot compute! Wrong input. Check the fields and try again!");
}
void MainWindow::printWrongArgument(){
    widget.output->setText("Result unreachable for given arguments.");
}